...
export const EveningQuestion = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const submitData = [
      ...
      {
        qid: 8,
        answer: formData.expectedSleepQuality === "" ? [] : [formData.expectedSleepQuality],
      },
    ];
    ...
    <div className="container">
      ...
      <form onSubmit={handleSubmit} className="form">
        <div className="formGroup">
          <label className="formLabel">1. 您感到幸福嗎？（請從0到10分進行打分）</label>
          <input
            type="number"
            name="happiness"
            min="0"
        ...
        <div className="formGroup">
          <label className="formLabel">2. 您感到壓力嗎？（請從0到10分進行打分）</label>
          <input
            type="number"
            name="stress"
            min="0"
        ...
        <div className="formGroup">
          <label className="formLabel">3. 作為家庭照顧者，您對自己今天的表現感到滿意嗎？（請從0到10分進行打分）</label>
          <input
            type="number"
            name="satisfaction"
            min="0"
        ...
        <div className="formGroup">
          <label className="formLabel">4. 除了您照顧的家人以外，今天您和多少人說過話？請填寫數字</label>
          <input
            type="number"
            name="socialCount"
            min="0"
        ...
        <div className="formGroup">
          ...
          <div>
            {["配偶", "父母", "子女", "孫子女", "其他家人或親戚", "朋友", "鄰居", "同事", "其他人"].map((relation) => (
        ...
        <div className="formGroup">
          <label className="formLabel">6. 除了照顧家人，您今天是否為自己做了任何事情或活動？（可多選）</label>
          <div>
            {[
              "有報酬的工作",
              "志願者活動或向他人提供幫助",
        ...
        <div className="formGroup">
          <label className="formLabel">7. 您今天在提供照顧時是否得到了充分的支援？（請從0到10分進行打分）</label>
          <input
            type="number"
            name="supportLevel"
            min="0"
        ...
        <div className="formGroup">
          <label className="formLabel">8. 您覺得您今晚能睡得好嗎？（請從0到10分進行打分）</label>
          <input
            type="number"
