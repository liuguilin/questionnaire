...
export const MorningQuestion = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const submitData = [
      ...
      {
        qid: 5,
        answer: formData.otherActivity ? [...formData.careActivities, formData.otherActivity] : formData.careActivities,
      },
    ];
    ...
    <div className="container">
      ...
      <form onSubmit={handleSubmit} className="form">
        <div className="formGroup">
          <label className="formLabel">1. 您昨天晚上睡得好嗎？（請從0到10分進行打分）</label>
          <input
            type="number"
            name="sleepQuality"
            min="0"
        ...
        <div className="formGroup">
          <label className="formLabel">2. 今天起床後，您是否感到精力充沛？（請從0到10分進行打分）</label>
          <input
            type="number"
            name="energyLevel"
            min="0"
        ...
        <div className="formGroup">
          <label className="formLabel">3. 您今天是否要為家庭成員提供照顧？</label>
        ...
        <div className="formGroup">
          <label className="formLabel">4. 今天需要照顧的家庭成員為（可多選）</label>
          <div>
        ...
        <div className="formGroup">
          <label className="formLabel">
            5. 作為家庭照顧者，您今天需要做哪些具體的事項或活動？（從以下事項中選擇，可多選）
          </label>
          <div>
            {[
              "協助工具性事務",
